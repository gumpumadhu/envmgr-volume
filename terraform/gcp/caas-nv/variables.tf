...
variable "gpu_type" {
  ...
  description = "GPU SKU To attach to GKE GPU Node (eg. nvidia-tesla-k80)"
}
...
variable "gke_blueprint" {
  description = "Rafay blueprint Name"
  type = string
}
variable "gke_blueprint_version" {
